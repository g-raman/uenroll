/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6291a95c033b7c81430b4f65d43c588b)
// Runtime types generated with workerd@1.20260114.0 2024-10-22 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ORCHESTRATOR_WORKFLOW: Workflow<Parameters<import("./src/index").OrchestratorWorkflow['run']>[0]['payload']>;
		TERMS_AND_SUBJECTS_SCRAPER_WORKFLOW: Workflow<Parameters<import("./src/index").TermsAndSubjectsScraperWorkflow['run']>[0]['payload']>;
		TERM_ORCHESTRATOR_WORKFLOW: Workflow<Parameters<import("./src/index").TermOrchestratorWorkflow['run']>[0]['payload']>;
		SUBJECTS_SCRAPER_WORKFLOW: Workflow<Parameters<import("./src/index").SubjectsScraperWorkflow['run']>[0]['payload']>;
		TOO_MANY_RESULTS_WORKFLOW: Workflow /* TooManyResultsWorkflow */;
	}
}
