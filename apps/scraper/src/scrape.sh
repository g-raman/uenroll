...
deno task scrape:terms >> /var/logs/uenroll/terms.log
deno task scrape:subjects >> /var/logs/uenroll/subjects.log
deno task scrape:courses >> /var/logs/uenroll/courses.log
